...
squad_json = "model/squad.json"
vocab_file = "model/vocab.txt"
cache_file = "model/calibratorCache.data"
seq_len = 128

bs = BertBatchStream(squad_json, vocab_file, cache_file, 1, seq_len, 500)
...
real_calibrator = forward.TrtInt8Calibrator(bs, cache_file,
                                            forward.MINMAX_CALIBRATION)
builder.setCalibrator(real_calibrator)
engine = builder.build("../Forward/models/squad_model.pb", infer_mode,
                       dummy_input)
engine.save("squad_model.engine")

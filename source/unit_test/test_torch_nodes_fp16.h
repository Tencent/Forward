...
TEST(TestTorchNodesFp16, AdaILN) {
...
TEST(TestTorchNodesFp16, Arithmetic) {
...
TEST(TestTorchNodesFp16, Activation) {
...
TEST(TestTorchNodesFp16, AdaptivePooling2d) {
...
TEST(TestTorchNodesFp16, AdaptivePooling3d) {
...
TEST(TestTorchNodesFp16, BatchNorm2d) {
...
TEST(TestTorchNodesFp16, Conv2d) {
...
TEST(TestTorchNodesFp16, ConstantPad2d) {
...
TEST(TestTorchNodesFp16, ConstantPad3d) {
...
TEST(TestTorchNodesFp16, Deconv2d) {
...
TEST(TestTorchNodesFp16, Expand) {
...
TEST(TestTorchNodesFp16, EmbeddingBagModule) {
...
TEST(TestTorchNodesFp16, FullyConnected) {
...
TEST(TestTorchNodesFp16, GridSamplerBilinearModule) {
...
TEST(TestTorchNodesFp16, GridSamplerNearestModule) {
...
TEST(TestTorchNodesFp16, IndexModule) {
...
TEST(TestTorchNodesFp16, Inplace) {
...
TEST(TestTorchNodesFp16, InstanceNorm2d) {
...
TEST(TestTorchNodesFp16, InstanceNorm2dTrack) {
...
TEST(TestTorchNodesFp16, InstanceNorm2dAffine) {
...
TEST(TestTorchNodesFp16, InstanceNorm2dAffineTrack) {
...
TEST(TestTorchNodesFp16, LayerNorm) {
...
TEST(TestTorchNodesFp16, LayerNormWithWeights) {
...
TEST(TestTorchNodesFp16, LrnModule) {
...
TEST(TestTorchNodesFp16, Pooling2d) {
...
TEST(TestTorchNodesFp16, Pooling3d) {
...
TEST(TestTorchNodesFp16, Permute) {
...
TEST(TestTorchNodesFp16, ReflectionPad2d) {
...
TEST(TestTorchNodesFp16, Repeat) {
...
TEST(TestTorchNodesFp16, Softmax) {
...
TEST(TestTorchNodesFp16, SplitStack) {
...
TEST(TestTorchNodesFp16, UpsamplingBilinear2dWithSize) {
...
TEST(TestTorchNodesFp16, UpsamplingNearest2dWithSize) {
...
TEST(TestTorchNodesFp16, UpsamplingBilinear2dWithScale) {
  const auto model_path =
...
TEST(TestTorchNodesFp16, UpsamplingNearest2dWithScale) {
  const auto model_path =
...
TEST(TestTorchNodesFp16, Unsqueeze) {
...
#ifdef SUPPORT_RNN
TEST(TestTorchNodesFp16, BidirectionRNN) {
...
TEST(TestTorchNodesFp16, LstmModule) {
...
TEST(TestTorchNodesFp16, Lstm2Module) {
...
TEST(TestTorchNodesFp16, GruModule) {
...
TEST(TestTorchNodesFp16, RnnModuleTanHBid) {
  const auto model_path = std::string(torch_root_dir) + "nodes/rnn_tanh_bidirectional.pth";
  const auto input = torch::randn({1, 28, 28}, device).to(c10::kHalf);
...
TEST(TestTorchNodesFp16, RnnModuleRelu) {

...
#undef T_CCHECK_LE
#undef T_CCHECK_GE
#undef T_CCHECK_BOUNDS
#undef T_CCHECK_NOTNULL
#undef T_CHECK
#undef T_PCHECK
#undef T_CHECK_EQ
#undef T_CHECK_NE
...
#undef T_CHECK_LE
#undef T_CHECK_GE
#undef T_CHECK_BOUNDS
#undef T_CHECK_NOTNULL
#define T_CCHECK(condition, ...) do{CLOG_IF(!(condition), FATAL, __VA_ARGS__) << "Check failed: [" << #condition << "] "; if(!(condition)) {return {};}}while(0)
#define T_CPCHECK(condition, ...) do{CLOG_IF(!(condition), FATAL, __VA_ARGS__) << "Check failed: [" << #condition << "] "; if(!(condition)) {return {};}}while(0)
#define T_CHECK(condition) T_CCHECK(condition, ELPP_CURR_FILE_LOGGER_ID)
#define T_PCHECK(condition) T_CPCHECK(condition, ELPP_CURR_FILE_LOGGER_ID)
#define T_CCHECK_EQ(a, b, ...) T_CCHECK(a == b, __VA_ARGS__)
#define T_CCHECK_NE(a, b, ...) T_CCHECK(a != b, __VA_ARGS__)
#define T_CCHECK_LT(a, b, ...) T_CCHECK(a < b, __VA_ARGS__)
#define T_CCHECK_GT(a, b, ...) T_CCHECK(a > b, __VA_ARGS__)
#define T_CCHECK_LE(a, b, ...) T_CCHECK(a <= b, __VA_ARGS__)
#define T_CCHECK_GE(a, b, ...) T_CCHECK(a >= b, __VA_ARGS__)
#define T_CCHECK_BOUNDS(val, min, max, ...) T_CCHECK(val >= min && val <= max, __VA_ARGS__)
#define T_CHECK_EQ(a, b) T_CCHECK_EQ(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_NE(a, b) T_CCHECK_NE(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_LT(a, b) T_CCHECK_LT(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_GT(a, b) T_CCHECK_GT(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_LE(a, b) T_CCHECK_LE(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_GE(a, b) T_CCHECK_GE(a, b, ELPP_CURR_FILE_LOGGER_ID)
#define T_CHECK_BOUNDS(val, min, max) T_CCHECK_BOUNDS(val, min, max, ELPP_CURR_FILE_LOGGER_ID)
#define T_CCHECK_NOTNULL(ptr, ...) T_CCHECK((ptr) != nullptr, __VA_ARGS__)
#define T_CHECK_NOTNULL(ptr) T_CCHECK_NOTNULL((ptr), ELPP_CURR_FILE_LOGGER_ID)

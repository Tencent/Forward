# Contributing to Forward
Welcome to [report Issues](https://www.github.com/Tencent/Forward/issues) or [pull requests](https://github.com/Tencent/Forward/merge_requests). It's recommended to read the following Contributing Guide first before contributing. 
...
## License
By contributing to Forward, you agree that your contributions will be licensed
under its [Apache v2.0 LICENSE](https://www.github.com/Tencent/Forward/blob/master/LICENSE)